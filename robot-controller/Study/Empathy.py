...
class Empathy(BaseStudy):
    ...
    def _initGeneral(self):
        ...
        wgtButtons.append([[
                ...
                ActionPushButton(None, "IDLE (ChinHoldL)", [
                        Stiffness(1.0),
                ...
                ActionPushButton(None, "IDLE (ChinHoldR)", [
                        Stiffness(1.0),
                ...
                ActionPushButton(None, "PalmUpLeft", [
                        Stiffness(1.0),
                ...
                ActionPushButton(None, "PalmUpRight", [
                        Stiffness(1.0),
                        Motion("PalmUpRight", speed = 1.5),
                        AutoRunAction(),
                    ]),
                ActionPushButton(None, "PalmUpRight", [
                        Stiffness(1.0),
