...
class Empathy(QtGui.QWidget):
    ...
    def _setupUi(self):
        ...
        Empathy._setupScenario(self, splitter)
        Empathy._setupMotions(self, splitter)
        Empathy._setupInteractions(self, splitter)
        Empathy._setupSudokuUi(self, splitter)
    ...
    def _setupSudokuUi(self, wgt):
        ...
        for i in range(bhv.getMaxLevel() + 1):
            ...
            bhv.add(i, None, "PalmUpRight")
        #END for
        widgets.append(EmpathyButton(bhv))
        self._bhvAnswer = bhv
