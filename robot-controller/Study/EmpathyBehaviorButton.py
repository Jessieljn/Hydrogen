...
class EmpathyBehaviorButton(QtGui.QPushButton):
    ...
    @staticmethod
    def _initBehaviors():
        bhv = EmpathyBehaviorButton("Idle (Big)")
        for i in range(10):
        ...
        bhv = EmpathyBehaviorButton("Idle (Small)")
        for i in range(10):
            bhv.add(i, motion = str(i) + "_Idle1")
        #END for
        EmpathyBehaviorButton._behaviours.append(bhv)
        ...
        bhv.add(0, [Speech("I barely can see."), Speech("Tell me what you wrote.")])
        ...
        bhv.add(1, [Speech("I barely can see."), Speech("Teh- teh-" + EmpathyBehaviorButton._markSpeech() + "tell me what you wrote.", speed = 90, shaping = 130)])
        ...
        bhv.add(2, [Speech("I barely can see."), Speech("Teh- teh- teh- teh-.", speed = 90, shaping = 130), Speech("Sorry. Tell me what you wrote.")])
